...
<script>
    $(document).ready(function () {
        ...
        $("#date_established").datepicker('setDate', '<?php echo $array_data->date_established; ?>');
    });
</script>
...
<div id="div_main" class="border" style="display: none;">
    ...
    {{ Form::hidden('id_company',$array_data->id_company) }}
    <div>
        {{ Form::label('company_name','Company Name: ',array('class' => 'form-control')) }}
        {{ Form::text('company_name',$array_data->company_name,array('required' => 'required', 'maxlength'=>100)) }}
    </div>
    <div>
    ...
    <div>
        ...
        {{ Form::text('date_established',$array_data->date_established,array('required' => 'required')) }}
    </div>
    <div>
